export dir='../../MC'
root -l -b -q -pthreads -fopenmp -ftree-vectorize -msse -ffast-math 'eff.cc++("$dir", "minisample_Dst2D0pi_D02Kpi_2016_Dw_GEN", "down")' > log/log1.txt 2> log/err1.txt
root -l -b -q -pthreads -fopenmp -ftree-vectorize -msse -ffast-math 'eff.cc++("$dir", "minisample_Dst2D0pi_D02Kpi_2016_Up_GEN", "up")' > log/log2.txt 2> log/err2.txt
root -l -b -q -pthreads -fopenmp -ftree-vectorize -msse -ffast-math 'eff.cc++("$dir", "all", "up_down")' > log/log3.txt 2> log/err3.txt
