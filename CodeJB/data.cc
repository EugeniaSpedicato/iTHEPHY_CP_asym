...
//other RooFit
  ...
  ROOT::EnableThreadSafety();
  RooAbsReal* nll_neg = model_neg->createChi2(*dataset1, Extended(), NumCPU(nThreads), RooFit::PrintLevel(-1), RooFit::PrintEvalErrors(-1));
  ...
  RooAbsReal* nll_pos = model_pos->createChi2(*dataset2, Extended(), NumCPU(nThreads), RooFit::PrintLevel(-1), RooFit::PrintEvalErrors(-1));
